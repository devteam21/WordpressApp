...
public class AnmeegamFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_anmeegam, container, false);
    ...
    public void getCategoryPost() {
        ...
        Call<List<Post>> call = service.getCategoryPost("27", page_no);
        call.enqueue(new Callback<List<Post>>() {
            ...
            public void onResponse(@NonNull Call<List<Post>> call, @NonNull Response<List<Post>> response) {
                ...
                try {
                    ...
                    }else{mShimmerViewContainer.startShimmer();
